  ...
  class Client
    module Templates
      ...
      def add_sms_template(options = {})
        post(RESOURCE_BASE_URL + 'templates/sms', options)
      end
      ...
      def get_sms_template(id, options = {})
        get(RESOURCE_BASE_URL + "templates/sms/#{id}", options)
      end
      ...
      def list_sms_templates(options = {})
        get(RESOURCE_BASE_URL + 'templates/sms', options)
      end
      ...
      def update_sms_template(id, options = {})
        put(RESOURCE_BASE_URL + "templates/sms/#{id}", options)
      end
      ...
      def partial_sms_template_update(id, options = {})
        post(RESOURCE_BASE_URL + "templates/sms/#{id}", options)
      end
      ...
      def remove_sms_template(id, options = {})
        delete(RESOURCE_BASE_URL + "templates/sms/#{id}", options)
      end
    end
  end
end
