  ...
  class Client
    module Factors
      ...
      def get_factor(user_id, factor_id, options = {})
        get(RESOURCE_BASE_URL + "users/#{user_id}/factors/#{factor_id}", options)
      end
      ...
      def list_enrolled_factors(user_id, options = {})
        get(RESOURCE_BASE_URL + "users/#{user_id}/factors", options)
      end
      ...
      def list_factors_to_enroll(user_id, options = {})
        get(RESOURCE_BASE_URL + "users/#{user_id}/factors/catalog", options)
      end
      ...
      def list_security_questions(user_id, options = {})
        get(RESOURCE_BASE_URL + "users/#{user_id}/factors/questions", options)
      end
      ...
      def enroll_factor(user_id, options = {})
        post(RESOURCE_BASE_URL + "users/#{user_id}/factors", options)
      end
      ...
      def activate_factor(user_id, factor_id, options = {})
        post(RESOURCE_BASE_URL + "users/#{user_id}/factors/#{factor_id}/lifecycle/activate", options)
      end
      ...
      def reset_factor(user_id, factor_id, options = {})
        delete(RESOURCE_BASE_URL + "users/#{user_id}/factors/#{factor_id}", options)
      end
      ...
      def verify_security_question_factor(user_id, factor_id, options = {})
        post(RESOURCE_BASE_URL + "users/#{user_id}/factors/#{factor_id}/verify", options)
      end
      ...
      def poll_for_verify_transaction_completion(user_id, factor_id, transaction_id, options = {})
        get(RESOURCE_BASE_URL + "users/#{user_id}/factors/#{factor_id}/transactions/#{transaction_id}", options)
      end
