  ...
  class Client
    module AdminRoles
      ...
      def list_roles_assigned_to_user(id, options = {})
        get(RESOURCE_BASE_URL + "users/#{id}/roles", options)
      end
      ...
      def assign_role_to_user(id, options = {})
        post(RESOURCE_BASE_URL + "users/#{id}/roles", options)
      end
      ...
      def unassign_role_from_user(user_id, role_id, options = {})
        delete(RESOURCE_BASE_URL + "users/#{user_id}/roles/#{role_id}", options)
      end
      ...
      def list_group_targets_for_user_admin_role(user_id, role_id, options = {})
        get(RESOURCE_BASE_URL + "users/#{user_id}/roles/#{role_id}/targets/groups", options)
      end
      ...
      def add_group_target_to_user_admin_role(user_id, role_id, group_id, options = {})
        put(RESOURCE_BASE_URL + "users/#{user_id}/roles/#{role_id}/targets/groups/#{group_id}", options)
      end
      ...
      def remove_group_target_from_user_admin_role(user_id, role_id, group_id, options = {})
        delete(RESOURCE_BASE_URL + "users/#{user_id}/roles/#{role_id}/targets/groups/#{group_id}", options)
      end
      ...
      def list_app_targets_for_app_admin_role(user_id, role_id, options = {})
        get(RESOURCE_BASE_URL + "users/#{user_id}/roles/#{role_id}/targets/catalog/apps", options)
      end
      ...
      def add_app_target_to_app_admin_role(user_id, role_id, app_name, options = {})
        put(RESOURCE_BASE_URL + "users/#{user_id}/roles/#{role_id}/targets/catalog/apps/#{app_name}", options)
      end
      ...
      def remove_app_target_from_app_admin_role(user_id, role_id, app_name, options = {})
        delete(RESOURCE_BASE_URL + "users/#{user_id}/roles/#{role_id}/targets/catalog/apps/#{app_name}", options)
      end
    end
  end
end
