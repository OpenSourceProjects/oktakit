  ...
  class Client
    module Users
      ...
      def create_user(options = {})
        post(RESOURCE_BASE_URL + 'users', options)
      end
      ...
      def get_user(id, options = {})
        get(RESOURCE_BASE_URL + "users/#{id}", options)
      end
      ...
      def list_users(options = {})
        get(RESOURCE_BASE_URL + 'users', options)
      end
      ...
      def update_user(id, options = {})
        if options.delete(:partial)
          post(RESOURCE_BASE_URL + "users/#{id}", options)
        else
          put(RESOURCE_BASE_URL + "users/#{id}", options)
        end
      end
      ...
      def get_assigned_app_links(id, options = {})
        get(RESOURCE_BASE_URL + "users/#{id}/appLinks", options)
      end
      ...
      def get_member_groups(id, options = {})
        get(RESOURCE_BASE_URL + "users/#{id}/groups", options)
      end
      ...
      def activate_user(id, options = {})
        post(RESOURCE_BASE_URL + "users/#{id}/lifecycle/activate", options)
      end
      ...
      def deactivate_user(id, options = {})
        post(RESOURCE_BASE_URL + "users/#{id}/lifecycle/deactivate", options)
      end
      ...
      def suspend_user(id, options = {})
        post(RESOURCE_BASE_URL + "users/#{id}/lifecycle/suspend", options)
      end
      ...
      def unsuspend_user(id, options = {})
        post(RESOURCE_BASE_URL + "users/#{id}/lifecycle/unsuspend", options)
      end
      ...
      def unlock_user(id, options = {})
        post(RESOURCE_BASE_URL + "users/#{id}/lifecycle/unlock", options)
      end
      ...
      def reset_password(id, options = {})
        post(RESOURCE_BASE_URL + "users/#{id}/lifecycle/reset_password", options)
      end
      ...
      def expire_password(id, options = {})
        post(RESOURCE_BASE_URL + "users/#{id}/lifecycle/expire_password", options)
      end
      ...
      def reset_factors(id, options = {})
        post(RESOURCE_BASE_URL + "users/#{id}/lifecycle/reset_factors", options)
      end
      ...
      def forgot_password(id, options = {})
        post(RESOURCE_BASE_URL + "users/#{id}/credentials/forgot_password", options)
      end
      ...
      def change_password(id, options = {})
        post(RESOURCE_BASE_URL + "users/#{id}/credentials/change_password", options)
      end
      ...
      def change_recovery_question(id, options = {})
        post(RESOURCE_BASE_URL + "users/#{id}/credentials/change_recovery_question", options)
      end
      ...
      def clear_user_sessions(id, options = {})
        delete(RESOURCE_BASE_URL + "users/#{id}/sessions", options)
      end
    end
  end
end
