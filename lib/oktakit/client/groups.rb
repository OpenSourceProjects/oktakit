  ...
  class Client
    module Groups
      ...
      def add_group(options = {})
        post(RESOURCE_BASE_URL + 'groups', options)
      end
      ...
      def get_group(id, options = {})
        get(RESOURCE_BASE_URL + "groups/#{id}", options)
      end
      ...
      def list_groups(options = {})
        get(RESOURCE_BASE_URL + 'groups', options)
      end
      ...
      def update_group(id, options = {})
        put(RESOURCE_BASE_URL + "groups/#{id}", options)
      end
      ...
      def remove_group(id, options = {})
        delete(RESOURCE_BASE_URL + "groups/#{id}", options)
      end
      ...
      def list_group_members(id, options = {})
        get(RESOURCE_BASE_URL + "groups/#{id}/users", options)
      end
      ...
      def add_user_to_group(group_id, user_id, options = {})
        put(RESOURCE_BASE_URL + "groups/#{group_id}/users/#{user_id}", options)
      end
      ...
      def remove_user_from_group(group_id, user_id, options = {})
        delete(RESOURCE_BASE_URL + "groups/#{group_id}/users/#{user_id}", options)
      end
      ...
      def list_assigned_applications(id, options = {})
        get(RESOURCE_BASE_URL + "groups/#{id}/apps", options)
      end
    end
  end
end
