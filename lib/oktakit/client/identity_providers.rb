  ...
  class Client
    module IdentityProviders
      ...
      def add_identity_provider(options = {})
        post(RESOURCE_BASE_URL + 'idps', options)
      end
      ...
      def get_identity_provider(id, options = {})
        get(RESOURCE_BASE_URL + "idps/#{id}", options)
      end
      ...
      def list_identity_providers(options = {})
        get(RESOURCE_BASE_URL + 'idps', options)
      end
      ...
      def update_identity_provider(id, options = {})
        put(RESOURCE_BASE_URL + "idps/#{id}", options)
      end
      ...
      def delete_identity_provider(id, options = {})
        delete(RESOURCE_BASE_URL + "idps/#{id}", options)
      end
      ...
      def activate_identity_provider(id, options = {})
        post(RESOURCE_BASE_URL + "idps/#{id}/lifecycle/activate", options)
      end
      ...
      def deactivate_identity_provider(id, options = {})
        post(RESOURCE_BASE_URL + "idps/#{id}/lifecycle/deactivate", options)
      end
      ...
      def get_identity_provider_transaction(transaction_id, options = {})
        get(RESOURCE_BASE_URL + "idps/tx/#{transaction_id}", options)
      end
      ...
      def get_source_idp_user_for_idp_transaction(transaction_id, options = {})
        get(RESOURCE_BASE_URL + "idps/tx/#{transaction_id}/source", options)
      end
      ...
      def get_target_user_for_idp_provision_transaction(transaction_id, options = {})
        get(RESOURCE_BASE_URL + "idps/tx/#{transaction_id}/target", options)
      end
      ...
      def list_users_for_idp_link_transaction(transaction_id, options = {})
        get(RESOURCE_BASE_URL + "idps/tx/#{transaction_id}/users", options)
      end
      ...
      def provision_idp_user(transaction_id, options = {})
        post(RESOURCE_BASE_URL + "idps/tx/#{transaction_id}/lifecycle/provision", options)
      end
      ...
      def link_idp_user(transaction_id, user_id, options = {})
        post(RESOURCE_BASE_URL + "idps/tx/#{transaction_id}/lifecycle/confirm/#{user_id}", options)
      end
      ...
      def add_x509_certificate_public_key(options = {})
        post(RESOURCE_BASE_URL + 'idps/credentials/keys', options)
      end
      ...
      def get_key(key_id, options = {})
        get(RESOURCE_BASE_URL + "idps/credentials/keys/#{key_id}", options)
      end
      ...
      def list_keys(options = {})
        get(RESOURCE_BASE_URL + 'idps/credentials/keys', options)
      end
      ...
      def delete_key(key_id, options = {})
        delete(RESOURCE_BASE_URL + "idps/credentials/keys/#{key_id}", options)
      end
    end
  end
end
