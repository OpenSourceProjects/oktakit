  ...
  class Client
    module Apps
      ...
      def add_application(options = {})
        post(RESOURCE_BASE_URL + 'apps', options)
      end
      ...
      def get_application(id, options = {})
        get(RESOURCE_BASE_URL + "apps/#{id}", options)
      end
      ...
      def list_applications(options = {})
        get(RESOURCE_BASE_URL + 'apps', options)
      end
      ...
      def update_application(id, options = {})
        put(RESOURCE_BASE_URL + "apps/#{id}", options)
      end
      ...
      def delete_application(id, options = {})
        delete(RESOURCE_BASE_URL + "apps/#{id}", options)
      end
      ...
      def activate_application(id, options = {})
        post(RESOURCE_BASE_URL + "apps/#{id}/lifecycle/activate", options)
      end
      ...
      def deactivate_application(id, options = {})
        post(RESOURCE_BASE_URL + "apps/#{id}/lifecycle/deactivate", options)
      end
      ...
      def assign_user_to_application_for_sso(id, options = {})
        post(RESOURCE_BASE_URL + "apps/#{id}/users", options)
      end
      ...
      def get_assigned_user_for_application(app_id, user_id, options = {})
        get(RESOURCE_BASE_URL + "apps/#{app_id}/users/#{user_id}", options)
      end
      ...
      def list_users_assigned_to_application(id, options = {})
        get(RESOURCE_BASE_URL + "apps/#{id}/users", options)
      end
      ...
      def list_applications_assigned_to_user(user_id, options = {})
        get(RESOURCE_BASE_URL + "apps?filter=user.id+eq+\"#{user_id}\"&expand=user/#{user_id}", options)
      end
      ...
      def update_application_credentials_for_assigned_user(app_id, user_id, options = {})
        post(RESOURCE_BASE_URL + "apps/#{app_id}/users/#{user_id}", options)
      end
      ...
      def remove_user_from_application(app_id, user_id, options = {})
        delete(RESOURCE_BASE_URL + "apps/#{app_id}/users/#{user_id}", options)
      end
      ...
      def assign_group_to_application(app_id, group_id, options = {})
        put(RESOURCE_BASE_URL + "apps/#{app_id}/groups/#{group_id}", options)
      end
      ...
      def get_assigned_group_for_application(app_id, group_id, options = {})
        get(RESOURCE_BASE_URL + "apps/#{app_id}/groups/#{group_id}", options)
      end
      ...
      def list_groups_assigned_to_application(id, options = {})
        get(RESOURCE_BASE_URL + "apps/#{id}/groups", options)
      end
      ...
      def remove_group_from_application(app_id, group_id, options = {})
        delete(RESOURCE_BASE_URL + "apps/#{app_id}/groups/#{group_id}", options)
      end
      ...
      def generate_new_application_key_credential(app_id, options = {})
        post(RESOURCE_BASE_URL + "apps/#{app_id}/credentials/keys/generate", options)
      end
      ...
      def list_key_credentials_for_application(app_id, options = {})
        get(RESOURCE_BASE_URL + "apps/#{app_id}/credentials/keys", options)
      end
      ...
      def get_key_credential_for_application(app_id, key_id, options = {})
        get(RESOURCE_BASE_URL + "apps/#{app_id}/credentials/keys/#{key_id}", options)
      end
      ...
      def preview_saml_metadata_for_application(app_id, options = {})
        get(RESOURCE_BASE_URL + "apps/#{app_id}/sso/saml/metadata", options)
      end
    end
  end
end
